...
SBT ?= java -Xmx$(JVM_MEMORY) -Xss8M -XX:MaxMetaspaceSize=256M -jar $(base_dir)/sbt-launch.jar
SHELL := /bin/bash
...
FIRRTL ?= java -Xmx$(JVM_MEMORY) -Xss8M -XX:MaxMetaspaceSize=256M -cp "$(FIRRTL_JAR)":"$(ROCKET_CLASSES)" firrtl.Driver
